...
from ..spectrum import create_spectrum_structure, resample_spectrum, convolve_spectrum, resample_spectrum, correct_velocity
from ..lines import _sampling_uniform_in_velocity
